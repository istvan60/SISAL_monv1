...
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`P_T_PET_AET` (
  ...
  `site_id` INT NOT NULL,
  `product_yyyy` INT NULL DEFAULT NULL,
  `product_mm` INT NULL DEFAULT NULL,
  `product_precip` DOUBLE NULL DEFAULT NULL,
  `product_temp` DOUBLE NULL DEFAULT NULL,
  `product_pet` DOUBLE NULL DEFAULT NULL,
  `product_aet` DOUBLE NULL DEFAULT NULL,
  `product_d18O` DOUBLE NULL DEFAULT NULL,
  `product_d2H` DOUBLE NULL DEFAULT NULL,
	INDEX `fk_P_T_PET_AET_SITE1_idx` (`site_id` ASC),
	PRIMARY KEY (`id`),
	CONSTRAINT `fk_P_T_PET_AET_SITE1`
	 FOREIGN KEY (`site_id`)
	 REFERENCES `SISAL_Monv1`.`SITE` (`site_id`)
	 ON DELETE CASCADE
	 ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`PRECIP_SITE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`PRECIP_SITE` (  
  ...
  UNIQUE INDEX `precip_site_id_UNIQUE` (`precip_site_id` ASC),
  UNIQUE INDEX `precip_site_name_UNIQUE` (`precip_site_name` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`PRECIP_ENTITY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`PRECIP_ENTITY` (
  ...
  UNIQUE INDEX `precip_entity_id_UNIQUE` (`precip_entity_id` ASC),
  UNIQUE INDEX `precip_entity_name_UNIQUE` (`precip_entity_name` ASC))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`PRECIP_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`PRECIP_SAMPLE` (
  ...
  INDEX `fk_PRECIP_SAMPLE_PRECIP_ENTITY1_idx` (`precip_entity_id` ASC),
  PRIMARY KEY (`precip_sample_id`),
  CONSTRAINT `fk_PRECIP_SAMPLE_PRECIP_ENTITY1`
    FOREIGN KEY (`precip_entity_id`)
    REFERENCES `SISAL_Monv1`.`PRECIP_ENTITY` (`precip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`CAVE_ENTITY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`CAVE_ENTITY` (
  `site_id` INT NOT NULL,
  ...
  INDEX `fk_CAVE_ENTITY_SITE1_idx` (`site_id` ASC),
  PRIMARY KEY (`cave_entity_id`),
  CONSTRAINT `fk_CAVE_ENTITY_SITE1`
    FOREIGN KEY (`site_id`)
    REFERENCES `SISAL_Monv1`.`SITE` (`site_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
/*
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`CAVE_TEMPERATURE_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`CAVE_TEMPERATURE_SAMPLE` (
  ...
  INDEX `fk_CAVE_TEMPERATURE_CAVE_ENTITY1_idx` (`cave_entity_id` ASC),
  PRIMARY KEY (`cave_temperature_sample_id`),
  CONSTRAINT `fk_CAVE_TEMPERATURE_CAVE_ENTITY1`
    FOREIGN KEY (`cave_entity_id`)
    REFERENCES `SISAL_Monv1`.`CAVE_ENTITY` (`cave_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`CAVE_RELATIVE_HUMIDITY_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`CAVE_RELATIVE_HUMIDITY_SAMPLE` (
  `cave_entity_id` INT NOT NULL,
  ...
  INDEX `fk_CAVE_RELATIVE_HUMIDITY_CAVE_ENTITY1_idx` (`cave_entity_id` ASC),
  PRIMARY KEY (`cave_relative_humidity_sample_id`),
  CONSTRAINT `fk_CAVE_RELATIVE_HUMIDITY_CAVE_ENTITY1`
    FOREIGN KEY (`cave_entity_id`)
    REFERENCES `SISAL_Monv1`.`CAVE_ENTITY` (`cave_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`CAVE_pCO2_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`CAVE_pCO2_SAMPLE` (
  `cave_entity_id` INT NOT NULL,
  ...
  INDEX `fk_CAVE_pCO2_CAVE_ENTITY1_idx` (`cave_entity_id` ASC),
  PRIMARY KEY (`cave_pCO2_sample_id`),
  CONSTRAINT `fk_CAVE_pCO2_CAVE_ENTITY1`
    FOREIGN KEY (`cave_entity_id`)
    REFERENCES `SISAL_Monv1`.`CAVE_ENTITY` (`cave_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`DRIP_ENTITY`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`DRIP_ENTITY` (
  `site_id` INT NOT NULL,
  ...
  INDEX `fk_DRIP_ENTITY_SITE1_idx` (`site_id` ASC),
  PRIMARY KEY (`drip_entity_id`),
  CONSTRAINT `fk_DRIP_ENTITY_SITE1`
    FOREIGN KEY (`site_id`)
    REFERENCES `SISAL_Monv1`.`SITE` (`site_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`DRIP_ISO_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`DRIP_ISO_SAMPLE` (
  ...
  INDEX `fk_DRIP_ISO_SAMPLE_DRIP_ENTITY1_idx` (`drip_entity_id` ASC),
  PRIMARY KEY (`drip_iso_sample_id`),
  CONSTRAINT `fk_DRIP_ISO_SAMPLE_DRIP_ENTITY1`
    FOREIGN KEY (`drip_entity_id`)
    REFERENCES `SISAL_Monv1`.`DRIP_ENTITY` (`drip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`DRIP_RATE_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`DRIP_RATE_SAMPLE` (
  `drip_entity_id` INT NOT NULL,
  ...
  INDEX `fk_DRIP_RATE_DRIP_ENTITY1_idx` (`drip_entity_id` ASC),
  PRIMARY KEY (`drip_rate_sample_id`),
  CONSTRAINT `fk_DRIP_RATE_DRIP_ENTITY1`
    FOREIGN KEY (`drip_entity_id`)
    REFERENCES `SISAL_Monv1`.`DRIP_ENTITY` (`drip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`MOD_CARB_SAMPLE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`MOD_CARB_SAMPLE` (
  `drip_entity_id` INT NOT NULL,
  ...
  INDEX `fk_MOD_CARB_SAMPLE_DRIP_ENTITY1_idx` (`drip_entity_id` ASC),
  PRIMARY KEY (`mod_carb_sample_id`),
  CONSTRAINT `fk_MOD_CARB_SAMPLE_DRIP_ENTITY1`
    FOREIGN KEY (`drip_entity_id`)
    REFERENCES `SISAL_Monv1`.`DRIP_ENTITY` (`drip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`SITE_LINK_REFERENCE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`SITE_LINK_REFERENCE` (  
  `site_id` INT NOT NULL,
  `ref_id` INT NOT NULL,
  INDEX `fk_SITE_LINK_REFERENCE_REFERENCE1_idx` (`ref_id` ASC),
  INDEX `fk_SITE_LINK_REFERENCE_SITE1_idx` (`site_id` ASC),
  CONSTRAINT `fk_SITE_LINK_REFERENCE_REFERENCE1`
    FOREIGN KEY (`ref_id`)
    REFERENCES `SISAL_Monv1`.`REFERENCE` (`ref_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_SITE_LINK_REFERENCE_SITE1`
    FOREIGN KEY (`site_id`)
    REFERENCES `SISAL_Monv1`.`SITE` (`site_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `SISAL_Monv1`.`SITE_LINK_PRECIP`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`SITE_LINK_PRECIP` (
  `site_id` INT NOT NULL,
  `precip_site_id` INT NOT NULL, 
  `precip_entity_id` INT NOT NULL, 
  INDEX `fk_SITE_LINK_PRECIP_PRECIP_ENTITY1_idx` (`precip_entity_id` ASC),
  INDEX `fk_SITE_LINK_PRECIP_PRECIP_SITE1_idx` (`precip_site_id` ASC),
  INDEX `fk_SITE_LINK_PRECIP_SITE1_idx` (`site_id` ASC),  
  CONSTRAINT `fk_SITE_LINK_PRECIP_PRECIP_ENTITY1`
    FOREIGN KEY (`precip_entity_id`)
    REFERENCES `SISAL_Monv1`.`PRECIP_ENTITY` (`precip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_SITE_LINK_PRECIP_PRECIP_SITE1`
    FOREIGN KEY (`precip_site_id`)
    REFERENCES `SISAL_Monv1`.`PRECIP_SITE` (`precip_site_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_SITE_LINK_PRECIP_SITE1`
    FOREIGN KEY (`site_id`)
    REFERENCES `SISAL_Monv1`.`SITE` (`site_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `SISAL_Monv1`.`ENTITY_LINK_REFERENCE` (
  ...
  `drip_entity_id` INT NOT NULL,
  `ref_id` INT NOT NULL,
  INDEX `fk_ENTITY_LINK_REFERENCE_PRECIP_ENTITY1_idx` (`precip_entity_id` ASC),
  INDEX `fk_ENTITY_LINK_REFERENCE_CAVE_ENTITY1_idx` (`cave_entity_id` ASC),
  INDEX `fk_ENTITY_LINK_REFERENCE_DRIP_ENTITY1_idx` (`drip_entity_id` ASC),
  INDEX `fk_ENTITY_LINK_REFERENCE_REFERENCE1_idx` (`ref_id` ASC),
  CONSTRAINT `fk_ENTITY_LINK_REFERENCE_PRECIP_ENTITY1`
    FOREIGN KEY (`precip_entity_id`)
    REFERENCES `SISAL_Monv1`.`PRECIP_ENTITY` (`precip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ENTITY_LINK_REFERENCE_CAVE_ENTITY1`
    FOREIGN KEY (`cave_entity_id`)
    REFERENCES `SISAL_Monv1`.`CAVE_ENTITY` (`cave_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ENTITY_LINK_REFERENCE_DRIP_ENTITY1`
    FOREIGN KEY (`drip_entity_id`)
    REFERENCES `SISAL_Monv1`.`DRIP_ENTITY` (`drip_entity_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
